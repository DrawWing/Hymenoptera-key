...
subtitle: "<https://github.com/DrawWing/Hymenoptera>"
...
::: columns
::: column
Body without a marked constriction between the 1st and 2nd abdominal segments (Fig. [58](#f5), [64](#f9)).  
Wings: fully developed, fore wing: with an enclosed anal cell (Fig. [16](#f2), [59](#f6), [61](#f8)).  
[Symphyta] - [2](#k2)
  
![Fig. 58. Pamphilius sylvaticus (Pamphiliidae). (Maria Komorowska, CC BY-NC 3.0, after Gauld and Bolton 1988)](fig-58.png "Fig. 58. Pamphilius sylvaticus (Pamphiliidae). (Maria Komorowska, CC BY-NC 3.0, after Gauld and Bolton 1988)"){style="border:1px solid black;"}![Fig. 59. Blasticotoma - fore wing. (Zofia Kościuszko, CC BY-NC 3.0, after Gauld and Bolton 1988)](fig-59.png "Fig. 59. Blasticotoma - fore wing. (Zofia Kościuszko, CC BY-NC 3.0, after Gauld and Bolton 1988)"){style="border:1px solid black;"}
:::
::: column
Body with a constriction between the 1st and 2nd abdominal segments (Fig. [121](#f17)), if the constrictipn is secondarily obscured (Fig. [96](#f15)) than fore wing without enclosed cells.  
Wings: fully developed, vestigal or absent, fore wing: if present then without an enclosed anal cell (Fig. [17](#f3), [76](#f11), [115](#f16)).  
[Apocrita] - [7](#k7)
...
::: columns
::: column
Antenna: inserted on ventral side of head, close to mandibles (Fig. 40).  
...
Antenna: with third segment long and stout, followed by a filament of 9 or more slender segments (Fig. 41). - Xyeloidea
:::
::: column
...
:::
::: column
Cenchri: present (Fig. 43).  
Abdomen: cylindrical or depressed, not constricted anteriorly (Fig. 72, 73). - Siricoidea
:::
:::
...
::: columns
::: column
Pronotum: in dorsal view with hind margin more or less straight (Fig. 44).  
Vein 2r-rs of fore wing: present.  
Labrum: concealed (Fig. 46).  
Mid tibiae and hind tibiae: with preapical spurs.  
Antenna with 18 or more segments (Fig. [58](#f5)). - Megalodontoidea
...
:::
::: column
Pronotum: in dorsal view with hind margin strongly bowed (Fig. 45, or if weakly bowed then fore wing with 2r-rs absent.  
Vein 2r-rs of fore wing: present or absent.  
Labrum: exposed (Fig. 47).  
...
::: columns
::: column
Segment 1 of gaster inserted high up on propodeum so gap between propodeal foramen and insertion of hind coxa is about equal to or greater than gap between foramen and hind margin of metanotum (Fig. 79-[80](#f13)). - [9](#k9)
...
Fore wing with costal cell distinct (Fig. 79, [80](#f13)). - Evanioidea
  
![Fig. 80. Gasteruptrion jucator (Gasteruptiidae) - fore wing. (Weronika Stelnicka, CC BY-NC 3.0, after Gauld and Bolton 1988)](fig-80.png "Fig. 80. Gasteruptrion jucator (Gasteruptiidae) - fore wing. (Weronika Stelnicka, CC BY-NC 3.0, after Gauld and Bolton 1988)"){style="border:1px solid black;"}
:::
::: column
Antenna: with 18 or more segments.  
Fore wing with costal cell obliterated, veins C, Sc, R and Rs fused between wing base and pterostigma (Fig. 120) - Ichneumonoidea (part)
:::
:::
...
::: columns
::: column
Fore wing with one enclosed cell, or without any enclosed cells (Fig. 98-108; 111-113; 132) - [12](#k12)
:::
::: column
Fore wing with two or more cells clearly delineated by veins (Fig. 14, 15, 81, 110, 119-122, 144). - [19](#k19)
:::
:::
...
:::
::: column
Alitrunk with pronotum extending back to almost touch tegulae (Fig. 51); wings with or without closed cells. - [15](#k15)
:::
:::
...
fore wing venation characteristic (Fig. 84, [85](#f14), 86), with a fairly large radial cell, that is either open anteriorly, or the only enclosed cell in the wing;   
...
fore wing with 10 enclosed cells (Fig. [75](#f10)). - Trigonalyoidea
...
hind wing without a distinct jugal lobe (Fig. 119-122);   
...
::: columns
::: column
First tergite of gaster short, fused with sternite to form a ring-like, highly sclerotized segment; second tegite (or syntergite) longer than tergites 1 and 3+ combined (Fig. 52); spiracles not present at least on first and apparent second gastral tergites; fore wing usually with 2 enclosed cells (costal and radial)(Fig. 110), rarely with up to 3 more enclosed cells (thus making a maximum of 5)(Fig. 109) - Proctotrupoidea (part)
:::
::: column
...
::: columns
::: column
Fore wing with radial cell either not indicated or open distally, and without any complete submarginal (cubital) cells; hind wing without enclosed cells (Fig. 136-138). - Chrysidoidea (in part)
:::
::: column
...
::: columns
::: column
Pronotum with upper hind corner widely separated from tegulae, and lower down the side with a pronounced prontal lobe covering mesothoracic spiracle (Fig. 55). - Apoidea
:::
::: column
...
<a id="f2"></a>2. Fig. 16. Xyelidae - wing cells. (from Gauld and Bolton 1988)  
  
<a id="f3"></a>3. Fig. 17. Apidae - wings. (Gabriela Karaszkiewicz, CC BY-NC 3.0, after Gauld and Bolton 1988)  
![Fig. 17. Apidae - wings. (Gabriela Karaszkiewicz, CC BY-NC 3.0, after Gauld and Bolton 1988)](fig-17.png "Fig. 17. Apidae - wings. (Gabriela Karaszkiewicz, CC BY-NC 3.0, after Gauld and Bolton 1988)"){style="border:1px solid black;"}  
  
<a id="f4"></a>4. Fig. 42. Cephus - abdomen, dorsal view. (Adam Tofilski, CC BY-NC 3.0, after Gauld and Bolton 1988)  
![Fig. 42. Cephus - abdomen, dorsal view. (Adam Tofilski, CC BY-NC 3.0, after Gauld and Bolton 1988)](fig-42.png "Fig. 42. Cephus - abdomen, dorsal view. (Adam Tofilski, CC BY-NC 3.0, after Gauld and Bolton 1988)"){style="border:1px solid black;"}  
  
<a id="f5"></a>5. Fig. 58. *Pamphilius sylvaticus* (Pamphiliidae). (Maria Komorowska, CC BY-NC 3.0, after Gauld and Bolton 1988)  
![Fig. 58. Pamphilius sylvaticus (Pamphiliidae). (Maria Komorowska, CC BY-NC 3.0, after Gauld and Bolton 1988)](fig-58.png "Fig. 58. Pamphilius sylvaticus (Pamphiliidae). (Maria Komorowska, CC BY-NC 3.0, after Gauld and Bolton 1988)"){style="border:1px solid black;"}  
  
<a id="f6"></a>6. Fig. 59. Blasticotoma - fore wing. (Zofia Kościuszko, CC BY-NC 3.0, after Gauld and Bolton 1988)  
...
<a id="f7"></a>7. Fig. 60. Cimbex - antenna. (Adam Tofilski, CC BY-NC 3.0, after Gauld and Bolton 1988)  
...
<a id="f8"></a>8. Fig. 61. Tenthredo - fore wing.  
  
<a id="f9"></a>9. Fig. 64. *Arge pagana* (Argidae). (from Gauld and Bolton 1988)  
  
<a id="f10"></a>10. Fig. 75. Trigonalis hahnii (Trigonalyidae) - wing. (Tomasz Orkisz, CC BY-NC 3.0, after Gauld and Bolton 1988)  
![Fig. 75. Trigonalis hahnii (Trigonalyidae) - wing. (Tomasz Orkisz, CC BY-NC 3.0, after Gauld and Bolton 1988)](fig-75.png "Fig. 75. Trigonalis hahnii (Trigonalyidae) - wing. (Tomasz Orkisz, CC BY-NC 3.0, after Gauld and Bolton 1988)"){style="border:1px solid black;"}  
  
<a id="f11"></a>11. Fig. 76. Aulacus - fore wing.   
  
<a id="f12"></a>12. Fig. 78. Aulacus - head. (Adam Tofilski, CC BY-NC 3.0, after Gauld and Bolton 1988)  
...
<a id="f13"></a>13. Fig. 80. Gasteruptrion jucator (Gasteruptiidae) - fore wing. (Weronika Stelnicka, CC BY-NC 3.0, after Gauld and Bolton 1988)  
![Fig. 80. Gasteruptrion jucator (Gasteruptiidae) - fore wing. (Weronika Stelnicka, CC BY-NC 3.0, after Gauld and Bolton 1988)](fig-80.png "Fig. 80. Gasteruptrion jucator (Gasteruptiidae) - fore wing. (Weronika Stelnicka, CC BY-NC 3.0, after Gauld and Bolton 1988)"){style="border:1px solid black;"}  
  
<a id="f14"></a>14. Fig. 85. Tribliographa rapae (Eucoilidae) - fore wing. (Maja Tomaszewska, CC BY-NC 3.0, after Gauld and Bolton 1988)  
![Fig. 85. Tribliographa rapae (Eucoilidae) - fore wing. (Maja Tomaszewska, CC BY-NC 3.0, after Gauld and Bolton 1988)](fig-85.png "Fig. 85. Tribliographa rapae (Eucoilidae) - fore wing. (Maja Tomaszewska, CC BY-NC 3.0, after Gauld and Bolton 1988)"){width="401" style="border:1px solid black;"}  
  
<a id="f15"></a>15. Fig. 96. *Thysanus ater* (Signiphoridae), female - dorsal view.  
  
<a id="f16"></a>16. Fig. 115. *Banchus* - fore wing.  
  
<a id="f17"></a>17. Fig. 121. *Meteorus ictericus* (Braconidae), female - dorsal view.  
